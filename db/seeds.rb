...
# Memories
Emotion.create(feeling: primary_feeling_options.sample, secondary_feeling: secondary_feeling_options.sample, intensity: Faker::Number.between(from = 1.00, to = 10.00).to_i)

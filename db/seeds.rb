...
primary_emotions = ['joyful', 'afraid', 'surprised', 'disgusted', 'angry']
strong_emotions = ['ecstatic', 'proud', 'terrified', 'amazed', 'depressed', 'mindful', 'awake', 'calm', 'panicking'] 
mild_emotions = ['serene', 'distracted', 'bored', 'annoyed', 'interested'] 
other_emotions = ['happy', 'sad', 'trusting', 'fortunate', 'productive', 'loving', 'loved', 'excited', 'care free','tired', 'anxious', 'pensive']
combinatory_emotions = ['remorseful', 'stressed', 'focused', 'indifferent', 'silly', 'confident']
emotions = primary_emotions + strong_emotions + mild_emotions + combinatory_emotions + other_emotions


#Thoughts
# @time_orientation = ['Future', 'Past', 'Present']
# @thought_type = ['Insightful', 'Experiential', šAutomatic']

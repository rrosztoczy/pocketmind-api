...
# Memories
Emotion.create(feeling: Faker::Number.number(10), mood: Faker::Number.number(10))
...
Activity.create(activity_category: activity_category.sample, activity_name: all_activities.sample, progress: rand(2) == 1)
Physical.create(stress_level: Faker::Number.number(10), physical_activity: physical_activities.sample)
Memory.create(user_id: users.last.id, emotion_id: emotions.last.id, thought_id: thoughts.last.id, physical_id: physicals.last.id, activity_id: activities.last.id)
